/**
 * Headless capture of StyleTestScene canvas (halftone on/off) — v3.
 * Usage: node scripts/capture-style-test-v3.mjs
 */
...
async function main() {
  ...
  try {
    await capture(page, "on", "style-test-v3-halftone-on.png");
    await capture(page, "off", "style-test-v3-halftone-off.png");
  } finally {
    await browser.close();
  }
}
