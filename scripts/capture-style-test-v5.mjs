/**
 * Headless capture of StyleTestScene canvas — v5 parchment isometric theme.
 * Usage: node scripts/capture-style-test-v5.mjs
...
async function main() {
  ...
  try {
    await capture(page, "style-test-v5-theme.png", "halftone=on&dof=on");
    // Logical MAP_Y = 392 of 540 → crop lower strip of displayed canvas
    await capture(page, "style-test-v5-map.png", "halftone=on&dof=on", {
      x: 0,
