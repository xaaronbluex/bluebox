/**
 * Headless capture of StyleTestScene canvas (halftone on/off) — v4.
 * Usage: node scripts/capture-style-test-v4.mjs
 */
...
async function main() {
  ...
  try {
    await capture(page, "on", "style-test-v4-halftone-on.png");
    await capture(page, "off", "style-test-v4-halftone-off.png");
  } finally {
    await browser.close();
  }
}
